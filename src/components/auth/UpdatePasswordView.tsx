  ...
  return (
    <div className="space-y-5">
      <div className="text-center">
        ...
        <p className="text-accent-silver text-sm mt-1">Choose a strong password for your account.</p>
      </div>

      <form action={updatePassword} onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label className="text-sm text-accent-silver mb-1.5 block" htmlFor="update-password">
            New password
          </label>
        ...
        <div>
          <label className="text-sm text-accent-silver mb-1.5 block" htmlFor="update-confirm">
